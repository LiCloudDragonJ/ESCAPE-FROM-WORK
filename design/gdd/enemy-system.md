...
| CEO 假身 | 50F(教学) | 200 | 1 | 教学关弱化版——裁员通知(AOE预警)、企业文化洗脑(短时控制)。击败后逃脱，CEO嘲讽："你会回来的" |
| CEO 半身 | 1F | 1200 | 2 | 裁员通知(范围秒杀，大范围预警)、企业文化洗脑(控制反转，3秒) |
| CEO 本体 | 50F(折返) | 2000 | 3 | 裁员通知(全屏AOE，仅安全点可躲)、企业文化洗脑(控制反转+召唤分身)、加班轮回(全屏减速+持续伤害)——最终Boss |
