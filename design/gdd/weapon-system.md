...
| 投影仪射线枪 | BulbLife | 25/s | 持续 | 100(5s) | 3s | 30m | 1° | 穿透敌人，持续伤害 |
| 马克杯投掷器 | Mug | 60 | 30 RPM | 3 | 3s | 25m | 8° | 抛物线AOE（3m半径） |
...
| 武器 | 轻击伤害 | 重击伤害 | 范围 | 蓄力时间 | 特殊 |
|------|---------|---------|------|---------|------|
| 碎纸机锯 | 12 | 40/s(2s持续) | 1.5m | 1s | 按住持续切割 |
| 网线鞭 | 10 | 28 | 3m | 1.5s | 中距离，可打多目标 |
| KPI报表锤 | 18 | 80 | 2m | 2s | 满蓄一击秒小怪 |
| 键盘板砖 | 14 | 35 | 1.2m | 0.8s | 可打断敌人攻击 |
| 马克杯流星锤 | 10 | 45 | 2.5m | 1.5s | 旋转AOE清围殴 |
